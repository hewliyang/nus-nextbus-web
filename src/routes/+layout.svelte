...
<div class="max-w-2xl mx-auto px-6 pb-3 flex flex-col items-center justify-between min-h-screen">
    <nav class="navbar border-b mb-3 justify-between h-14 p-3">
        <div class="flex-1">
        ...
        <div>
            <div class="flex gap-3 mr-3 items-center">
                ...
                <a class="hidden btn btn-warning btn-outline btn-sm md:flex items-center" href="/busroutes">All Routes</a>
            </div>
                ...
                <li>
                    ...
                    <ul class="bg-base-200 rounded-xl">
                        <form method="POST" use:enhance={submitUpdateTheme}>
                            <li>
                                <button formaction="/?/setTheme&theme=halloween&redirectTo={$page.url.pathname}" aria-label="dark-theme" class="rounded-xl">Dark</button>
                            </li>
                            <li>
                                <button formaction="/?/setTheme&theme=light&redirectTo={$page.url.pathname}" aria-label="light-theme" class="rounded-xl">Light</button>
                            </li>
                        </form>
                    </ul>
                </li>
    ...
    <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 inset-x-0 bottom-0 mt-auto rounded-2xl flex items-center justify-center shadow-xl">
